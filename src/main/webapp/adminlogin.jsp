...
<main class="form-signin w-100 m-auto">
  <form action="${pageContext.request.contextPath}/operation" method="post">
    ...
    <div class="form-floating">
      <input type="text" class="form-control" id="floatingInput" name="username" placeholder="john " required>
    ...
    <input type="hidden" name="form" value="adminLoginOperation">
    
    <input class="btn btn-primary w-100 py-2" type="submit"></button>
      <a href="${pageContext.request.contextPath}/operation?page=forgotPassword">Forgot Password?</a>
